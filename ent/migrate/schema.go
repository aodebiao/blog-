...
var (
	...
	ArticleColumns = []*schema.Column{
		...
		{Name: "del_flag", Type: field.TypeInt8, Nullable: true, SchemaType: map[string]string{"mysql": "tinyint(1)"}},
		{Name: "status", Type: field.TypeInt8, Nullable: true, SchemaType: map[string]string{"mysql": "tinyint(1)"}},
		{Name: "create_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "date"}},
		{Name: "update_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "date"}},
		{Name: "delete_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "date"}},
	...
	UserColumns = []*schema.Column{
		...
		{Name: "del_flag", Type: field.TypeInt8, SchemaType: map[string]string{"mysql": "tinyint(1)"}},
		{Name: "status", Type: field.TypeInt8, Nullable: true, SchemaType: map[string]string{"mysql": "tinyint(1)"}},
